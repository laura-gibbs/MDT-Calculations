...
!-------------------------------------------------
      logical :: msk_exists
      character(len=128) :: path0,pin1,pin2,pin3,pout,fin,fout
!-------------------------------------------------
!===========================================================    
...
!===========================================================      
!-------------------------------------------------
      pin1='./../a_mdt_data/computations/masks/'
      pin2='./../a_mdt_data/computations/mss/'
      pin3='./../a_mdt_data/computations/geoids/'
      pout='./../a_mdt_data/computations/mdts/'
!-------------------------------------------------
...
!-------------------------------------------------
      ...
      open(20,file=trim(pin3)//trim(fin),&
      &form='unformatted')
      read(20)geoid
      close(20)
