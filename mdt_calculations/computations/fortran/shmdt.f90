      ...
      integer, parameter :: i1=1,i2=4320,j1=1,j2=2160
      integer, parameter :: II=i2-i1+1 !=122
      integer, parameter :: JJ=j2-j1+1 !=30
      integer, parameter :: IIin=4320,JJin=2160
...
!------------------------------------------------
     do i=1,IIin
        glon(i)=0.08333*(i-0.5)
     end do

     do j=1,JJin
        glat(j)=0.08333*(j-0.5)-90.0
     end do
!------------------------------------------------
...
!-------------------------------------------------
      ...
      open(21,file=trim(path0)//'land_mask_12thdeg.dat',form='unformatted')
      read(21)mask
      close(21)
