...
from mdt_calculations.computations.gaussian_filter import apply_gaussian
...
def main():
    ...
    #                                  historical, number=2, start=3785)
    # h_acc1_r1_1851 = historical_cmip5[0].T
    # print(h_acc1_r1_1851.shape, h_acc1_r1_1851.dtype)
    # plot(access1_r1i1p1_1851)
